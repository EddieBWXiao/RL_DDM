...
sim_params(:,3) = unifrnd(v0_lb, v0_ub, n_sim_subjects, 1);
...
for i = 1:n_sim_subjects
    sim_data(i) = simfun_ddm_sgmhat_v0(sim_params(i,:), task);
end
recov = fit_ddm_sgmhat_v0(sim_data);
...
xlabel(sprintf('Simulated %s','v0'))
ylabel(sprintf('Recovered %s','v0'))
subplot(2,2,4)
